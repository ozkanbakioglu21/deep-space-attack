  ...
  },
{
      ...
      tagline: "Kaçış: göktaşlarından kaç, ne kadar uzun hayatta kalırsan skorun o kadar yükselir.",
      accent: "#ff9f43",
      hud: { showLevel: true, showCombo: true, levelLabel: "Dalga", scoreLabel: "Skor" },
      controls: [
        "Ekranda sürükle → gemi her yöne hareket eder (ok tuşları da çalışır).",
        "Göktaşlarına çarpma; hayatta kalmak için her saniye skor kazanırsın.",
        "Senden kaçıp alttan geçen her göktaşı bonus skor verir ve komboyu yükseltir.",
        "ALTIN göktaşı geçirmek çift skor; çok yakından kaçmak 'ÇOK YAKIN!' bonusu verir.",
        "Her dalgada göktaşları hızlanır ve sıklaşır.",
      ],
    },
    {
      id: "gather",
